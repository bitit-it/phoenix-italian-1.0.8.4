...
define('HEADING_TITLE_ORDER', 'Ordine #%s');

define('TAB_TITLE_SUMMARY','<i class="fas fa-info-circle fa-fw mr-1"></i>Sommario');
define('TAB_TITLE_PRODUCTS','<i class="fas fa-box-open fa-fw mr-1"></i>Prodotti');
define('TAB_TITLE_STATUS_HISTORY','<i class="fas fa-history fa-fw mr-1"></i>Cronologia');

define('TABLE_HEADING_OID', 'Ordine');
...
define('ENTRY_ADD_COMMENT', 'Add un Commento:');

define('ENTRY_NOTIFY_CUSTOMER_TEXT', 'Questo notificherà al cliente che il suo ordine è stato aggiornato.');
define('ENTRY_NOTIFY_COMMENTS_TEXT', 'Questo aggiungerà i tuoi commenti all\'ordine e all\'email.');
