...
define('HEADING_TITLE', 'Gestione Newsletter');

define('TABLE_HEADING_NEWSLETTERS', 'Newsletters');
define('TABLE_HEADING_DATE_ADDED', 'Data inserita');
...
define('TEXT_NEWSLETTER_DATE_ADDED', 'Data inserimento:  %s');
define('TEXT_NEWSLETTER_DATE_SENT', 'Data di spedizione:  %s');
...
define('ERROR_NEWSLETTER_MODULE_NOT_EXISTS', '<strong>Errore:</strong> Il modulo non è presente');
