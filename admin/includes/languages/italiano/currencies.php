...
define('TEXT_INFO_COMMON_CURRENCIES', '-- valuta accettata dagli --');
...
define('TEXT_INFO_CURRENCY_UPDATED', 'Il valore di cambio per %s (%s) è stato aggiornato con successo tramite  %s.');
...
define('ERROR_INSTALL_CURRENCY_CONVERTER', 'Non hai un modulo di conversione valuta installato.  <a class="alert-link font-weight-bold" href="' . tep_href_link('modules.php', 'set=currencies') . '">Install Now</a>');
?>
