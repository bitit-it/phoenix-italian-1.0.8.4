...
*/
  ...
  const MODULE_CONTENT_GDPR_CONTACT_ADDRESSES_NUM_ADDRESSES = 'Possiamo trovare <br><span class="h1"><span class="num_addresses">%s</span></span><br> indirizzo/i addizionalo/i';
