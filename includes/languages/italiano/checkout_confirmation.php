...
define('HEADING_SHIPPING_INFORMATION', 'Informazioni Spedizione');
...
define('IMAGE_BUTTON_FINALISE_ORDER', 'Concludi e paga %s per il tuo ordine');

define('HEADING_QTY', 'Qtà');
